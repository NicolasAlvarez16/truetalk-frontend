...
const Posts = () => {
    ...
    async function getUserPosts() {
        ...
        return axios.get("http://172.105.75.93:8002/api/posts/user-posts?uuid=" + uuidCall).then(res => {
    ...
    async function getFolloweePosts() {
        ...
        return axios.get("http://172.105.75.93:8002/api/posts/followee-posts?uuid=" + getUuid()).then(res => {
